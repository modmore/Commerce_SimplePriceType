...
if (!createObject('modNamespace',array(
    'name' => 'commerce_simplepricetype',
    'path' => $componentPath.'/core/components/commerce_simplepricetype/',
    'assets_path' => $componentPath.'/assets/components/commerce_simplepricetype/',
),'name', false)) {
    echo "Error creating namespace commerce_simplepricetype.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_simplepricetype.core_path',
    'value' => $componentPath.'/core/components/commerce_simplepricetype/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_simplepricetype',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_simplepricetype.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_simplepricetype.assets_path',
    'value' => $componentPath.'/assets/components/commerce_simplepricetype/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_simplepricetype',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_simplepricetype.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_simplepricetype/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_simplepricetype.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_simplepricetype',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_simplepricetype.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_simplepricetype.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_simplepricetype',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_simplepricetype.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_simplepricetype/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_simplepricetype/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce\\SimplePriceType\\Modules\\', $modulePath);
